...
export default function JourneySection() {
  ...
  return (
    <section className="relative overflow-hidden bg-white py-28 sm:py-36 dark:bg-app-dark-gradient">
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div ref={wrapRef} className="relative mt-20 hidden aspect-[10/3.4] w-full lg:block">
          <svg className="absolute inset-0 h-full w-full" viewBox="0 0 1000 280" fill="none" preserveAspectRatio="none">
            <path d="M 20 258 L 960 258" stroke="#E2E8F0" strokeWidth="1" strokeDasharray="4 6" className="dark:opacity-10" />
            <motion.path
              d={pathD}

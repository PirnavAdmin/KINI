...
import { BookOpen, Users2, Code2, Handshake, Briefcase } from 'lucide-react'
...
const milestones = [
  ...
  },
  {
    icon: Handshake,
    tag: 'Weeks 17–20',
    title: 'You intern with a real company',
    desc: 'Everything you\u2019ve built gets put to work in a live internship — real tickets, real stand-ups, real feedback from working teams, before you ever sit for a placement interview.',
    metric: 'Guaranteed internship placement',
  },
  {
    icon: Briefcase,
    tag: 'Placement',
...
export default function StorySection() {
  ...
  return (
    <section
      id="story"
      className="relative py-28 sm:py-36 bg-[linear-gradient(135deg,#B5DBFF_0%,#C4EFF6_55%,#D8FBF5_100%)] dark:bg-[linear-gradient(135deg,#0F172A_0%,#111827_50%,#0B1120_100%)]"
    >
      {/* Subtle pattern overlay – lower opacity in dark mode */}
      ...
      <div className="relative mx-auto max-w-6xl px-6">
        <SectionHeading
          ...
          subtitle="Five stages. No shortcuts skipped, no step outsourced — every learner walks the same verified path."
        />
        ...
        <div ref={containerRef} className="relative mt-20 grid gap-16 lg:grid-cols-[220px_1fr]">
          ...
          <div className="hidden lg:block">
            <div className="sticky top-32 h-[420px]">
              <div className="relative ml-3 h-full w-px bg-slate-200/50 dark:bg-white/10">
                <motion.div
                  ...
                  >
                    <span
                      className={`h-3.5 w-3.5 rounded-full border-2 transition-colors duration-500 ${
                        activeIndex >= i
                          ? 'border-[#085FA7] dark:border-primary-400 bg-white dark:bg-ink-950'
                          : 'border-slate-300 dark:border-white/20 bg-white/50 dark:bg-ink-950/50'
                      }`}
                    />
                    <span

              ...
              <section className="py-16 md:py-20">
                <div className="max-w-7xl mx-auto px-6">
                  <div className="text-center mb-8">
                    <span className="inline-flex items-center gap-2 rounded-full bg-[#EDF4FC] px-4 py-2 text-sm font-semibold text-[#085FA7]">
                      <div className="w-2 h-2 rounded-full bg-[#085FA7] animate-pulse" />
                      Choose Your Path
                    </span>
